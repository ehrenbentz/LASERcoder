...
MAIN_SCRIPT="main.py"
SOURCE_DIR="../src"
LIBS_DIR="../libs/mpv/macOS/${ARCH_LABEL}"
ICONS_DIR="../icons"
...
if [ ! -f "$ICONS_DIR/Icons.icns" ]; then
    echo "ERROR: Icons.icns not found at $ICONS_DIR/Icons.icns"
    exit 1
fi
...
# ==================================================================
# Rename app bundle (Nuitka names it after the source file, not the exe)
# ==================================================================
if [ -d "main.app" ] && [ "main.app" != "${APP_BUNDLE}" ]; then
    mv "main.app" "${APP_BUNDLE}"
fi
