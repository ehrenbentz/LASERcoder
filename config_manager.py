...
class ConfigManager:
    ...
    def __init__(self):
        ...
        self.config = None
        self.load_config()  # Initialize self.config
    ...
    def update_last_behavior_key(self, behavior_key):
        ...
        if behavior_key and isinstance(behavior_key, str):
            ...
            print(f"Updating last behavior key to: {behavior_key}")  # Debug print
            self.save_config()